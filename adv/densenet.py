...
def dense_block(x, nb_layers, nb_filter, growth_rate, bottleneck=False, dropout_rate=None, weight_decay=1E-4):
    ...
    for i in range(nb_layers):
        ...
        #x= merge.concatenate(feature_list,axis=-1)
...
def create_dense_net(nb_classes,softmax, img_dim, depth=40, nb_dense_block=3, growth_rate=12, nb_filter=-1,
    ...
    if softmax:
        x = Dense(nb_classes, activation='softmax', W_regularizer=l2(weight_decay), b_regularizer=l2(weight_decay),bias_initializer='zeros')(x)
    else:
