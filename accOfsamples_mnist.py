...
if __name__ == "__main__":
    ...
    #for attack in ['jsma','bim-a','bim-b','cw-l2']:   
    #for attack in ['brightness','contrast','scale']: 
    for attack in ['fgsm','jsma','bim-a','bim-b','cw-l2','rotation','translation','shear','brightness','contrast','scale']:
        ...
        #for measure in ['lsa','dsa','conditional','my','random']:
            ...
            for selectsize in [100,300,500,1000]:
                ...
                #result_to_write+='sample '+str(selectsize)+', '+measure+':\n'
                #starttime = time.time()
                result_to_write+='['
                for i in range(5):
                    print(attack)
