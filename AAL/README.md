...
, where <img src="http://chart.googleapis.com/chart?cht=tx&chl= $\beta$" style="border:none;"> is a tradeoff controlling parameter over the two terms. We tested all the parameters <img src="http://chart.googleapis.com/chart?cht=tx&chl= $\beta$" style="border:none;">, from 0.1 to 0.9, and finally found that 0.5 is the best choice, so we chose 0.5 as the fixed parameter of this experiment.
